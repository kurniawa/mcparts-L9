...
<div class="container">
    ...
    <br>
    <p><span class="fw-bold">Spec:</span></p>
...
<script>
    ...
    $("#nama_item").autocomplete({
        ...
        select: function(event, ui) {
            ...
            document.getElementById("nama-ukuran").textContent = nama_ukuran;
            document.getElementById("tr-ukuran").style.display = display_tr_ukuran;
            ...
            document.getElementById("nama-motif").textContent = nama_motif;
            document.getElementById("tr-motif").style.display = display_tr_motif;
    ...
    function getItemSpecs(chosen_item) {
        ...
        if (chosen_item.tipe === 'varia') {
            ...
            } else if (chosen_item.tipe === 'kombinasi') {
            }
