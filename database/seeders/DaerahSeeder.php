...
class DaerahSeeder extends Seeder
{
    ...
    public function run()
    {
        $daerahs = [
            ...
            ['nama'=>'Semarang', 'negara_id'=>1, 'pulau_id'=>2], // 30
